 ...
 * 2016-02-15T14:09:42.416+08:00
 * Generated source version: 3.1.5
 * 
 */
@WebServiceClient(name = "HelloWSService", 
                  wsdlLocation = "http://localhost:8081/services/hello?wsdl",
                  targetNamespace = "http://www.tmp.com/services/hello") 
public class HelloWSService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://www.tmp.com/services/hello", "HelloWSService");
    public final static QName HelloWSPort = new QName("http://www.tmp.com/services/hello", "HelloWSPort");
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8081/services/hello?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(HelloWSService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://localhost:8081/services/hello?wsdl");
        }
        WSDL_LOCATION = url;
    }
