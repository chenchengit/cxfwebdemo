 ...
 * generated in the com.rvho.cxfclient.wsdl.cxf.hello package. 
...
public class ObjectFactory {
    ...
    private final static QName _Welcome_QNAME = new QName("http://www.tmp.com/services/hello", "welcome");
    private final static QName _WelcomeResponse_QNAME = new QName("http://www.tmp.com/services/hello", "welcomeResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.rvho.cxfclient.wsdl.cxf.hello
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.tmp.com/services/hello", name = "welcome")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.tmp.com/services/hello", name = "welcomeResponse")
